<template>
  <div>
    ...
    <div >
      ...
      <table rules="all" style="border:1px solid" cellpadding="5">
        <tbody>
          ...
          <tr>
            <td>原住民音樂</td>
            <td colspan="2">
              阿美族、泰雅族、排灣族、布農族、卑南族、魯凱族、鄒族、賽夏族、雅美族(達悟族)、邵族、噶瑪蘭族、太魯閣族、撒奇萊雅族、賽德克族、拉阿魯哇族、卡那卡那富族、平埔族
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <h3>二、藝術(當代創作)音樂</h3>
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;藝術(當代創作)音樂發生場域包括了精緻的舞臺表演場所、或是藝術節、小眾表演場地&hellip;等非傳統樂種的活動場域。本領域著重觀察當代藝術音樂創作的活動，從局內、局外、遵循傳統、發揚創新等多角度、多層次的涵蓋，希能完整記錄一整年臺灣音樂創作的脈動，並提出相關的評述及觀察。
      </p>
      <p>
      ...
      <p>
        ...
        <sup>1</sup
        >流行音樂有其自成一體的產業結構背景，透過出版包裝、仰賴大眾傳播媒體平臺為其展演媒介。其產生與傳播的過程迥異於上述各種自然族群音樂、藝術音樂創作的發展模式，其內質與音樂語彙亦與其他音樂類型大相逕庭。《2018臺灣音樂年鑑》將流行音樂的展演活動及出版獨立成項予以記錄，希望藉由多角度的觀察，記錄流行音樂相關政策、民間團體作為、人文生態及學術研究等面向之發展。
      </p>
      <h3>四、跨界音樂</h3>
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;關於「跨界音樂」的定義，本年鑑援用「第29屆傳藝金曲獎獎勵辦法」(2018)中的相關條文：「跨界音樂：指風格與表現方式介於藝術音樂、流行音樂、傳統音樂或現代音樂之間，融合科技音樂等不同音樂之素材與技法進行創作或改編之音樂。」<sup>2</sup>本年鑑中所收錄之「跨界音樂」，係指介於傳統音樂、藝術(當代創作)音樂、流行音樂之間，屬於分項領域之間交越跨涉的表演創作案例。其餘或有結合多媒體、新媒體等媒材，抑或是結合戲劇、舞蹈等不同領域的「跨領域」表現形式；以及結合不同文化的「跨文化」音樂交融，是不同層面、不同意義的跨涉，亦可能在跨界表演的場域同時發生，但並非判定「跨界音樂」的必要歸屬條件。
      </p>
      ...
      <span>(一)展演(含祭儀)活動：活動名稱/時間/地點/個人(團體)簡介/活動簡介及內容/觀察與評介</span
      ><br />
      <span>(二)推廣教育：活動名稱/時間/地點/個人(團體)簡介/活動簡介及內容/觀察與評介</span><br />
      <span>(三)傳習活動：活動名稱/時間/地點/個人(團體)簡介/活動簡介及內容/觀察與評介</span><br />
      <span>(四)國際與兩岸交流：活動名稱/時間/地點/個人(團體)簡介/活動簡介及內容/觀察與評介</span
      ><br />
      <span
        >(五)研究與出版：發表(出版)時間/學術單位或出版機構/研究者(作者)簡介/研究(出版品)摘要/觀察與評介</span
      ><br />
      ...
      <p>
        一、本文鑑的文獻引用方式，參考美國心理協會 (American PsychologicalAssociation)
        所發行的APA格式(APA style)。
      </p>
      <p>
        二、若於論述中需引用音樂的採譜記錄，基本上，皆統一採用首調記譜法，在文字敘述中，一律以唱名來表示相對的音程關係，而不強調固定音高，比如以「la-mi-sol-mi」代表「完全四度下行－小三度上行－小三度下行」的音程關係，如有必要則以絕對音名補述。如：「CC&ndash;
        C &ndash; c &ndash; c' &ndash; c'' &ndash;
        c'''」(great/smallmethod)，其相應的音域如下列說明：
      </p>
      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c' = 中央C</span><br />
      ...
      ><br />
      <span
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;單篇文章、期刊論文、研討會論文以〈〉標示。英文書寫方式則依據AspanA格式。</span
      ><br />
      <span
      ...
      <div style="text-align:left;">
        <small
          >1.參見文化部影視及流行音樂產業局網站《104年流行音樂產業調查》報告(https://mocfile.moc.gov.tw/bamidhistory/149289715.pdf)</small
        >
        <br />
        <small
          >2.參見國立傳統藝術中心網站「第29屆傳藝金曲獎獎勵辦法」(https://mocfile.moc.gov.tw/files/201801/f5a1341a-cfd0-45df-9cd0-6db2c6192c2e.pdf)</small
        >
      </div>
    </div>
  </div>
