<template>
  <div>
    ...
    <p>
      ...
      <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在多民族與多元文化的激盪下，跨界思維普遍存在於藝術的創作、演出、展覽與播映中，這點在2019年度的藝文活動中即可以觀察到。值得一提的是，過去被認為令人匪夷所思的跨界合作模式，在今年度的演出中卻是屢見不鮮，如北管音樂與電子音樂、管樂與布袋戲，部分演出甚至是跨越多樂種、多領域到已經難以歸類為何種形式，以有如五光十色般豐富的秀場表演方式呈現。這些型態的演出常獲觀眾迴響而再回鍋，可見民眾對於跨界音樂的接受程度越來越高，所能欣賞的題材也越來越多元。如臺北市立交響樂團推出的臺北市音樂季－TSO名家系列「狂野的傳統」 ，該節目融合交響樂、北管以及傳統樂器笙的跨界詮釋，曲目不再只演奏西方樂曲，而是融匯了臺灣在地文化底蘊的全新創作，也打破了東西、古今的限制，透過北管音樂與交響樂團對話來激盪出全新的音樂感受。臺北市立國樂團也推出世界風系列「萬島綺想－不只甘美朗」 ，邀請遠自印尼的甘美朗樂團來臺，節目中更融合歌仔戲、國樂絲竹樂，透過不同樂種間的互動來實踐跨文化交流的目的。此外，由市民管樂團製作的「江湖救援團－管樂團ｘ布袋戲交響音樂會」 節目，更邀請無限人形劇場共同參與，以磅礡管樂結合戲偶以及cosplay演出，亦是較為特殊的跨界創作之一。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2019年度的藝術展演中，由作品的展示、表演、創作等層面都可以普遍發現其中的跨界思維，也逐漸打破過去既有的規範。如國家交響樂團推出的《托斯卡》 NSO歌劇音樂會與舞蹈家林懷民合作，將原本寫實主義的歌劇傳統變成了中國傳統戲曲「一桌二椅」的虛擬手法，也將演出重點由舞臺、劇情聚焦回演員的音樂表演上，再次體現當代音樂多元和無常的特性。
    </p>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大眾式的親民推廣節目方面，如臺北市立國樂團所製作的：臺灣歌劇《我的媽媽欠栽培》 結合國樂、音樂劇、歌仔戲與偶戲等元素，以跨界手法展現臺灣鄉土風情以及城鄉、人倫關係的演變；與鐵獅亮光樂團合作的「鐵獅戀國樂Ⅱ」 ，自2017年首次推出後即引發熱烈話題，並於今年度再次重新製作，在藝人澎恰恰與許效舜幽默的說學逗唱下，結合民謠、流行樂、國樂與舞蹈呈現出豐富又熱烈的秀場。另一公立國樂品牌的臺灣國樂團也不惶多讓，在2019年度重新製作2016、2017、2018年皆演出過的《寶島辦桌》 ，以臺灣的辦桌文化為主題，將吹打樂結合戲劇演出活潑的故事，也在今年加入歌仔戲的嶄新元素，展現多元又富有在地文化的跨界表演；而與真快樂掌中劇團合作的《布袋戲戀歌落花斷情雨》 亦是去年首次推出後的重新製作，結合布袋戲、視覺、燈光設計外，由真人扮演的布袋戲角色演奏樂器更是本劇的賣點之一，加入現代劇場的手法融匯傳統藝術於整體演出中。此外，采風樂坊也持續舊作新製，重新推出《阿銘上菜》 展現臺灣在地的辦桌文化，在原有的吹打樂劇場上加入舞曲元素來重新編曲，實踐其東方器樂劇場的理念。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;除了國樂團的跨界製作外，臺北市立交響樂團也推出TSO《跟著阿嬤去旅行》 音樂劇場，為首部結合皮影戲元素的原創臺灣兒童音樂劇，該劇以親和的語言和生活化的劇情將傳統的皮影戲融匯於西式音樂劇中，並結合現代戲劇元素，頗具新意的讓角色在真人與戲偶間虛實轉換，其中親民的歌曲、吸引人的故事，突破了交響樂團與一般民眾的隔閡。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在自我突破實驗取向的部分，如新點子實驗場以創作型室內樂團三個人與徐惟恩合作的「誤讀聲響」 ，以笛簫、古箏、中阮和鋼琴大玩聲響和即興，企圖創造全新的音響世界；由文怡和黃雅農合作的「痛 Tone：聲響實驗・嗩吶 x 合成器」 以嗩吶結合合成器、物件、人聲、接觸式麥克風、八軌混音器，將傳統樂器與現代科技交會出新火花，透過不斷的產生、打散、重組、輪迴的過程創造出一個開放式、沉浸式和互動式的影像聲響空間，與觀眾一同發掘聲音的質地，思考當代深沉的議題；此外，結合長笛、電子音樂和影像的「新庄24-1」 系列創作，選擇嘉義新庄當地改建的老戲院演出，以長笛獨奏搭配當地的自然與人文風情，在多媒體影像的融合下，展現出聲景交融獨特風貌之跨界作品。
      <br>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;現行的跨界製作常雜揉眾多元素以呈現某種藝術理念或目的，之後往往會發現難以將其歸類於現有的藝術形式中，於是將作品重新自我定義，並以全新的藝術形式再行推出。在器樂劇場方面：如采風樂坊除了多次重製的《十面埋伏》「東方器樂劇場」外也積極尋求突破，今年則推出「新絲竹音樂劇場」的《女．朋友》 主打絲竹樂劇場形式；朱宗慶打擊樂團繼多次改版的《木蘭》之後也在今年推出《泥巴》 ，更加實踐及豐富其「擊樂劇場」之理念。此外，不乏類似於音樂劇、歌劇等跨界製作的作品如：臺灣國樂團《節氣二四：夢遊奇幻國》 「國樂親子音樂劇場」、臺北市立國樂團《我的媽媽欠栽培》「臺灣歌劇」、臺北市立國樂團附設學院團的《巴別之塔：奪回勇者之心》 「類電玩音樂劇場」、柔聲音樂工作室《年華似水》 「新臺灣音樂劇場」、馨韻合唱團《回憶漲停板》 「歌中劇」、新語小集《我把比比變不見》 「音樂故事劇場」、臺灣藝術家交響樂團《誰怕虎姑婆》 「互動式親子音樂會」等作品，其中或多或少採取音樂劇、歌劇現場樂團演奏之主軸，結合戲劇、舞蹈元素後，再搭配如在地文化、跨文化、親子互動等創作主題，另包裝為全新的音樂劇場概念。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2019年也有為數不少的作品是主打多媒體等科技元素的跨界音樂會，如：以繪本為主題的森焱堂x幾米《忘記親一下》 「多媒體親子音樂劇場」、樂興之時管弦樂團《彩繪作曲家：貝多芬250年誕生紀念－上卷》 「多媒體音樂劇場」等節目，可以發現科技以及互動概念融合於音樂劇場形式中，企圖跳脫既有表演型態、展現新意。另外，較為特殊的為以文學為主題的跨界音樂會，如：新古典室內樂團《築詩．逐詩》 「文學音樂劇場」、市民管樂團《東野圭吾文學音樂會－操縱彩虹的少年》 、張艾嘉與嚴俊傑的音樂鬼故事《曖魅》 等作品，文學主題融會現場樂團演奏，並以多媒體投影文字、影片或朗誦詩文、故事，在文學與音樂的融會下，帶領聽眾遨遊於文字與音符的想像世界。
      <br>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新媒體 科技技術當作一種跨界手法來媒合各種多元素材，也因為新媒體科技擁有很高的複合性質，成為現今多媒體傳播的主要工具之一。在現代科技做為一種藝術創造的方法之餘，使得傳統的藝術理念與美學思考亦產生相當大的變化，也在這新的表演形式中賦予全新意義。
      <br>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;由2019年度的音樂跨界節目觀察中可以發現，在藝術節的號召下，各藝術團隊也積極參與、努力爭取曝光的機會，其中也因藝術節求新求變的特質，間接地鼓勵了創新的跨界製作。舉例來說，文化部所主導的國際性藝術節在今年推出不少大型跨界製作：如兩廳院主辦的「TIFA臺灣國際藝術節」由國家交響樂團藝術總監呂紹嘉與林懷民共同合作的《托斯卡》歌劇音樂會， 該作品在歌劇的主體下，雜揉了東西方文化素材的大型跨界展演；由國立傳統藝術中心主辦的「亞太傳統藝術節」也邀請印度、喬治亞、韓國、越南等地的藝術團體前來，促進臺灣與各國傳統文化的交流；此外，由文化部主辦的「西藏文化藝術節」《梵音神鼓音樂會》 ，也邀請尼泊爾歌手以梵音傳唱與優人神鼓結合的跨文化表演。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;除了文化部所辦理的大型藝術節外，在我國各都市由地方政府與民間團體所舉辦的藝術節則展現出更為多元而新潮的跨界演出，如「臺北藝術節」邀請亞洲代表性跨國實驗音樂組合FEN（Far East Network）共同打造「躁集2019《無主之島》」 ，以結合音樂、聲響、即興與科技等多元素呈現的跨界音樂會； 由空總臺灣當代文化實驗場（C-LAB）與法國「音樂與聲響研究統合中心」（IRCAM）合作的「C-LAB 聲響藝術節」，則與臺北市立國樂團、臺灣小提琴家蘇顯達所聯合創作演出的《梁祝小提琴協奏曲》 ，其中結合國立臺南藝術大學團隊、香港藝術家海潮以及真快樂掌中劇團聯手打造的偶戲動畫，特別的是觀眾必須戴上3D眼鏡配合現場音樂演出，在音樂會中導入新科技，讓聲音與視覺呈現嶄新風貌的新形態展演；「臺南藝術節」則推出《（Ｘ＿Ｘ）府城流水席》 ，以新媒體科技結合音樂、綜藝、舞蹈、說書、歌仔戲以及電音派對等多樣元素所創造出的大型秀場，其中不乏知名藝術創作者與團隊所共同製作，提供多元豐富的表演與市民共享；由民間單位獨立發起的「大稻埕國際藝術節」也重視跨時代、跨領域、跨國籍、跨文化甚至跨語言的藝術表演，以創新實驗表演形式連結在地， 如由國外藝術團體Siedl/Cao與國小學生以日常生活中熟悉的事物製作聲音裝置，共同創作《透過聲音、再次發掘遺忘的「珍寶」》 、《超級象徵》 開發日常物件的聲音潛能；由桃園市政府舉辦的「桃園科技藝術節」更是以科技藝術為主軸，邀集藝術創作者以當代聲響、互動裝置、影像等科技元素結合表演的展演活動；其他亦有整合臺北市大直內湖地區當地的娛樂、媒體、科技產業的「大內藝術節」；由當地藝術家、學校、社區與社團共同發起的「淡水環境藝術節」；交通部東海岸國家風景管理處辦理的「臺灣東海岸大地藝術節」等節慶皆有結合當地文化、發展地方特色的跨界演出。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;值得注意的是，由我國藝術大學所主辦的藝術節亦表現出亮眼的跨界成果，如臺北藝術大學主辦的「關渡光藝術節」作品《壞運動》（Moving Me Badly） ，透過新媒體藝術、煙霧、雷射、影像、聲響、穿戴裝置、舞蹈表演等不同元素的結合，並打破劇場的限制，在校內體育館、游泳池等實體環境中穿梭，帶領觀眾在跨媒體劇場、新媒體裝置以及舞蹈互動下所共同交織的奇幻旅程；此外，臺灣藝術大學主辦的「大觀國際表演藝術節」作品《時光冉冉》（Epitome of Time） ，也融會舞蹈、戲劇、美術與音樂等元素，以人類、科技與時間等當代的深沉議題，企圖創造出「超領域」的全新表演概念。觀察以上二個跨界作品可以發現，藝術學校的製作能夠以自有的資源，集結校內所有藝術科系學生來共同製作，也因為如此，相較於一般的跨界作品能夠有較多的突破性以及更多的實驗性質。
      <br>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2019年度由多齣為兒童創作的音樂表演作品中發現，除了過去常結合舞蹈、戲劇的音樂劇場外，近年來由於科技的普及化，使多媒體成為常態使用的素材，透過大型的投影撥放，讓繪本、故事等主題可以影像呈現出來。如：森焱堂x幾米《忘記親一下》以幾米繪本為主題，搭配多媒體投放所營造的繪本環境，以音樂、戲劇與布偶來說故事；高雄市交響樂團《十二生肖的故事－親子音樂繪》 則以十二生肖的故事為主軸，在現場交響樂團演奏下搭配多媒體與演員說故事，為兒童營造視覺與聽覺兼具的故事音樂劇場；較為特殊的為臺灣國樂團的作品《108年推廣教育音樂會－國樂頻道1 聽音樂說故事》 則是以國樂演奏為主，搭配現場說故事與圖片的撥放，除了單一場次的演奏外，同時結合教育推廣目的打造5種「國樂頻道」兒童節目，供不同學齡的兒童選取適合自己年齡層的節目觀看。
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其他場次的兒童節目如：新竹交響管樂團《皮克斯大冒險》 、新竹市立管樂團《啊～有怪獸！親子音樂會》 、臺灣藝術家交響樂團《誰怕虎姑婆－TASO互動式親子音樂會》、狂美交響管樂團《射日傳說》 親子音樂劇場、新語小集的《我把比比變不見》音樂故事劇場等作品，大多以音樂劇場為主要表演形式，亦可發現兒童節目除了音樂演奏外，更為重視主題的營造、劇情的連貫以及與觀眾的互動性。除此之外，兒童節目更是呈現出跨樂種、跨文化、跨越各種領域的樣貌，也因其具有的特殊性質，可以說兒童節目本身就是一種有目的性的跨界製作。
    </p>
    ...
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;藝術做為人類社會的產物之一，與人文社會的傳統、思想、以及文化的發展息息相關。回溯古代人類社會中，「樂」即是包含了音樂、舞蹈、戲劇的綜合性藝術，經過數百年來漫長的分科過程，發展成各自的專業領域、形成各自的美學與規訓，各藝術間也逐漸開始有了「界」線的存在。然而，歷經一連串現代化、全球化的演變過程，當代音樂已經具備多元、折衷與無常的特質，沒有任何單一的理論足以定義音樂，尤其在今天這樣一個全方位全球化的年代，音樂裡所謂的「普世價值」漸流於形式上的教義宣言；美國學者包曼（Philip V. Bohlman, 1999）一語道破：「音樂也許如我們思考的一般；但也許不是」 （頁v.），如此看似籠統而模稜兩可的言論，直接揭露了當代音樂無論在學理或實踐上的不確定性。也因為音樂自身的不確定因素，原屬於原生科目的「界」線也開始模糊，逐漸容許更多的詮釋空間。因此，當「音樂」的認知或所謂的詮釋權（authority of interpretation） 開始有所動搖、甚至被質疑時，對於音樂的實踐、乃至於存在方式，也在本世紀受到前所未有的檢視。從創作、展演、欣賞至評論，音樂存在於一個鮮活而環環相扣的有機歷程中，由於參與者（作曲者、演奏者、觀眾、評論者）等變動因素，音樂從來不是以單一或絕對的固定價值存在－音樂的本質是立體而多元的。
      <br>
    ...
    <h4>三、文化的趨同逐異</h4>
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;光世代的今天，從經濟、交通、科技、到政治、文化等皆進入全面全球化的地球村時代，音樂作為反映社會的人文產物，真真實實的將當代社會的多元與折衷的特質彰顯出來。音樂既可是在地化的個人演繹，亦可是全球化的宏觀詮釋；而看似琳瑯滿目、百花齊放，甚至眾說紛紜、眾聲喧嘩的各種跨界、跨文化音樂，或許是因緣於當代一種自信不足的時代特質。英國學者庫克（Nicholas Cook）與艾維瑞斯特（Ｍark Everist）（1999）便表示：「我們這個世代的音樂歷史與音樂理論，是處於一個缺乏自信的狀態；我們再也不知道我們知道什麼」 （頁v）。
      <br>
    ...
    <p>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;科技所帶來的革命性轉變也逐漸影響到音樂教育、以及藝術推廣層面，除了將表演藝術即時、無差別、透明化的宣傳出去外，亦增進民眾對藝術的科普知識，甚至是較為進階的技術層面、學術理論等，皆可透過這樣的形式傳播。現行較為知名的網路平臺如由鋼琴家官大為建置的作曲、編曲、即興和電腦音樂的免費教學網站「好和弦」（NiceChord） 、推廣表演藝術知識、理論、學術以及跨領域理念的「渡（Do）平台」 、甚至是「江老師」以幽默搞笑來笑談音樂的「笑哈哈LOL」 頻道；這些網路平臺往往同時經營官方網站、Youtube影片以及臉書（Facebook）等網路社群，形成以音樂知識傳播為主題的自媒體。而透過網路實行音樂教學的平臺如「MUZKY音樂人直播教學平台」 為首創由音樂人透過網路或手機App程式直播方式，突破音樂學習因時間、空間所造成的阻礙所創立的音樂教學平臺，亦有「Music2Gather音樂而聚」 提供學習者以線上實況互動或非實況的內容互動等多種方式學習音樂、此外也有「BONBONMUSIC音樂學習媒合平台」 透過網路資訊即時、透明的特性，供學習者媒合音樂教師家教提供實體的教學。其他由音樂教學業者所設立的網路資源更是多不勝數，亦可以說學習者只要有3C產品和通訊設備，就能以低廉的成本接收相關知識、學習技能。音樂也隨著網際網路、自媒體時代的來臨開啟與過去不同的發展方向。
    </p>
