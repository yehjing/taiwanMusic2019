  ...
  <div>
    ...
    <div class="scrollContent">
      ...
      <p>
        ...
        pit)。從此，樂池成了現代劇場的必要配置。以國家戲劇院和歌劇院而言，樂池具有升降機能，甚至還可以做為觀眾席的延伸。
      </p>
      <p>
      ...
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;美國音樂學者梅里亞姆(Alan P.
        Merriam，1923-1980)認為傳統音樂的發展當與社會環境的變遷以及因此變遷所形成的民族文化有關，而將傳統音樂的研究視野導向「文化中的音樂」。長期在中國進行傳統音樂調查與研究的荷蘭學者高文厚(F.Kouwenhoven，1945-
        )與其夫人施聶姐(A.Schimmelpennick，1962-2012)亦指出，保存傳統音樂固是理所當然，但文化是很難保存的。因為「文化」與「變化」是一體兩面，尤其音樂又是最易變的。惟，講求「移步不換形」的口傳藝術，如何在傳統的基礎上力求圖變求新，並藉由不同體質的文武場及國樂團之「異質同構」的磨合融入、運用發展，冀望仍能保住傳統歌仔戲鮮明統一的風格特色、自有規律及程式性，箇中因素確是值得從業者再深入思考！
      </p>
    </div>
  </div>
</template>
